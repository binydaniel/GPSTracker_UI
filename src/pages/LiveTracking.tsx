...
// import { Device, Vehicle, ApiDeviceResponse } from '@/features/tracking/types.ts';
// import {
//   Activity,
//   ArrowRight,
//   Battery,
...
// }
//
// interface DashboardTrackerData {
//   vehicles: Vehicle[];
//   devices: Device[];
//   mapConfig: {
...
//     devices: [],
//     mapConfig: {
//       center: [9.01377, 38.7101783], // Default coordinate space
//       zoom: 13,
//     },
//   });
//
//   // 1. Unified Concurrency Fetch Pipeline
//   React.useEffect(() => {
...
//   }, []);
//
//   // 2. Real-time Telemetry Stream via SignalR Hub
//   React.useEffect(() => {
...
//       if (!isMounted) return;
//
//       // Deep update nested array inside the DTO state topology
//       setTrackerData((prev) => ({
//         ...prev,
...
//   }, []);
//
//   // Sync selected vehicle details when array properties change over the wire
//   React.useEffect(() => {
//     if (selectedVehicle) {
...
//
//   // Derived filtered state mappings
...
//                 {trackerData.vehicles.length} Active
//               </Badge>
//             </div>
//           </div>
//
...
//                   </button>
//               ))}
//               {!isLoading && trackerData.vehicles.length === 0 && (
...
//                               {/*{trackerData.devices.map(n => n.name).join(', ')}*/}
//                             </p>
//                           </div>
//                         </div>
//                       </div>
